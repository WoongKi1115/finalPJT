  ...
  <div>
    ...
    <v-sheet class="mx-auto" max-width="1800">
      ...
      ><template v-slot:next>
        ...
        <v-slide-item
          class="mt-6"
          v-for="(randomMovie2, index) in randomGenreMovies2"
          :key="index"
        >
                ...
                <template v-slot:activator="{ on, attrs }">
                  <v-img
                    ...
                    :src="
                      ...
                      randomMovie2.poster_path
                    "
                    height="440"
                    @click="getMovieComment(randomMovie2)"
                  >
                  </v-img>
                </template>
                        ...
                        <div style="position: relative" class="pe-10">
                            ...
                            <v-row>
                              <v-col cols="9" style="font-size: medium">
                                ...
                                <div class="d-flex my-2">
                                  개봉일 : {{ randomMovie2.release_date }}
                                </div>
                                <div class="d-flex">
                                  감독 : {{ randomMovie2.director }}
                                </div>
                                <div
                                  class="d-flex my-2"
                          ...
                          >
                            ...
                            >
                              ...
                              <v-text-field
                                @keyup.enter="createMovieComment(randomMovie2)"
                                dark
                                class="pa-3"
                                style="background-color: #222222"
                                v-model="randomMovie2Comment"
                                :rules="nameRules"
                                :counter="50"
                                label="댓글"
                                required
                              ></v-text-field>
                              <v-btn
                                @click="createMovieComment(randomMovie2)"
...
export default {
  ...
  computed: {
    randomGenreMovies2() {
      const pickedMovies = _.sampleSize(
        this.$store.state.randomGenreMovies2,
        20
      );
      return pickedMovies;
    },
    randomGenre2() {
      const genresId = this.$store.state.randomGenre2;
  ...
  methods: {
    ...
    createMovieComment(pickedMovie) {
      ...
      const movie_comment = this.randomMovie2Comment;
      if (movie_comment == "") {
        alert("글을 입력하세요");
        return;
      }
